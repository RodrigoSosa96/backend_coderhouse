...
const holdingEmpresa = new schema.Entity('holdingEmpresa', {
    empresas: [empresaSchema]
});
const normalizeHolding = normalize(holding, holdingEmpresa);
print(normalizeHolding);
console.log(`
-----------------------------------------------------
longitud antes de normalizar: ${JSON.stringify(holding).length}
longitud despues de normalizar: ${JSON.stringify(normalizeHolding).length}
-----------------------------------------------------`);
